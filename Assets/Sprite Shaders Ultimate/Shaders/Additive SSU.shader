	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float3 To115_g11767 = ( pow( ( ( break2_g11768.x + break2_g11768.x + break2_g11768.y + break2_g11768.y + break2_g11768.y + break2_g11768.z ) / 6.0 ) , max( _ColorReplaceContrast , 0.001 ) ) * (_ColorReplaceToColor).rgb );
				...
				float4 appendResult4_g11803 = (float4(pow( (temp_output_1_0_g11803).rgb , temp_cast_30 ) , temp_output_1_0_g11803.a));
				...
				float3 lerpResult11_g11797 = lerp( (temp_output_1_0_g11797).rgb , ( lerpResult6_g11797 * pow( temp_output_3_0_g11797 , max( _SplitToningContrast , 0.001 ) ) ) , _SplitToningFade);
				...
				float3 lerpResult7_g11789 = lerp( (temp_output_1_0_g11789).rgb , ( (_InkSpreadColor).rgb * pow( ( ( break2_g11791.x + break2_g11791.x + break2_g11791.y + break2_g11791.y + break2_g11791.y + break2_g11791.z ) / 6.0 ) , max( _InkSpreadContrast , 0.001 ) ) ) , ( _InkSpreadFade * clampResult53_g11789 ));
				...
				#endif
				float4 appendResult6_g11785 = (float4(( ( hsvTorgb19_g11785 * pow( ( ( break2_g11787.x + break2_g11787.x + break2_g11787.y + break2_g11787.y + break2_g11787.y + break2_g11787.z ) / 6.0 ) , max( _AddHueContrast , 0.001 ) ) * staticSwitch33_g11785 ) + (temp_output_1_0_g11785).rgb ) , temp_output_1_0_g11785.a));
				...
				#endif
				float4 appendResult21_g11782 = (float4(( (temp_output_1_0_g11782).rgb + ( pow( ( ( break2_g11783.x + break2_g11783.x + break2_g11783.y + break2_g11783.y + break2_g11783.y + break2_g11783.z ) / 6.0 ) , max( _SineGlowContrast , 0.001 ) ) * staticSwitch27_g11782 * _SineGlowFade * ( ( ( sin( ( temp_output_39_0_g11763 * _SineGlowFrequency ) ) + 1.0 ) * ( _SineGlowMax - _SineGlowMin ) ) + _SineGlowMin ) ) ) , temp_output_1_0_g11782.a));
				...
				float4 appendResult12_g11764 = (float4(( ( lerpResult15_g11764 * _PingPongGlowFade * pow( ( ( break2_g11765.x + break2_g11765.x + break2_g11765.y + break2_g11765.y + break2_g11765.y + break2_g11765.z ) / 6.0 ) , max( _PingPongGlowContrast , 0.001 ) ) ) + (temp_output_5_0_g11764).rgb ) , temp_output_5_0_g11764.a));
				...
				float4 appendResult22_g11805 = (float4(( (_HologramTint).rgb * pow( ( ( break2_g11806.x + break2_g11806.x + break2_g11806.y + break2_g11806.y + break2_g11806.y + break2_g11806.z ) / 6.0 ) , max( _HologramContrast , 0.001 ) ) ) , ( max( pow( abs( sin( ( ( ( ( shaderTime237 * _HologramLineSpeed ) + ase_worldPos.y ) / unity_OrthoParams.y ) * _HologramLineFrequency ) ) ) , _HologramLineGap ) , _HologramMinAlpha ) * temp_output_1_0_g11805.a )));
				...
				float3 lerpResult4_g11842 = lerp( (temp_output_1_0_g11842).rgb , ( (lerpResult68_g11842).rgb * pow( ( ( break2_g11845.x + break2_g11845.x + break2_g11845.y + break2_g11845.y + break2_g11845.y + break2_g11845.z ) / 6.0 ) , max( _CamouflageContrast , 0.001 ) ) ) , _CamouflageFade);
				...
				#endif
				float4 lerpResult45_g11835 = lerp( temp_output_1_0_g11835 , ( ( max( ( ( _MetalHighlightDensity - localMyCustomExpression16_g11838 ) / max( _MetalHighlightDensity , 0.01 ) ) , 0.0 ) * _MetalHighlightColor * pow( temp_output_5_0_g11835 , max( _MetalHighlightContrast , 0.001 ) ) ) + ( pow( temp_output_5_0_g11835 , max( _MetalContrast , 0.001 ) ) * _MetalColor ) ) , staticSwitch60_g11835);
				...
				float3 lerpResult57_g11827 = lerp( (temp_output_1_0_g11827).rgb , ( ( pow( temp_output_7_0_g11827 , max( _FrozenContrast , 0.001 ) ) * (_FrozenTint).rgb ) + ( pow( temp_output_7_0_g11827 , max( _FrozenSnowContrast , 0.001 ) ) * ( (_FrozenSnowColor).rgb * max( ( _FrozenSnowDensity - localMyCustomExpression16_g11829 ) , 0.0 ) ) ) + (( max( ( ( _FrozenHighlightDensity - localMyCustomExpression16_g11832 ) / max( _FrozenHighlightDensity , 0.01 ) ) , 0.0 ) * _FrozenHighlightColor * pow( temp_output_7_0_g11827 , max( _FrozenHighlightContrast , 0.001 ) ) )).rgb ) , _FrozenFade);
				...
				float3 lerpResult29_g11821 = lerp( temp_output_28_0_g11821 , ( pow( ( ( break2_g11825.x + break2_g11825.x + break2_g11825.y + break2_g11825.y + break2_g11825.y + break2_g11825.z ) / 6.0 ) , max( _BurnInsideContrast , 0.001 ) ) * ( ( (_BurnInsideNoiseColor).rgb * clampResult68_g11821 ) + (_BurnInsideColor).rgb ) ) , clampResult18_g11821);
				...
				#endif
				float4 appendResult8_g11813 = (float4(( temp_output_57_0_g11813 + ( ( pow( lerpResult92_g11813 , temp_cast_70 ) * (_ShineColor).rgb ) * clampResult80_g11813 * staticSwitch98_g11813 ) ) , (temp_output_1_0_g11813).a));
				...
				float4 appendResult27_g11848 = (float4(( ( max( pow( abs( ( ( ( localMyCustomExpression16_g11850 + ( temp_output_41_0_g11848 * _PoisonShiftSpeed ) ) % 1.0 ) + -0.5 ) ) , max( _PoisonDensity , 0.001 ) ) , 0.0 ) * temp_output_24_0_g11848 * _PoisonFade * _PoisonNoiseBrightness ) + lerpResult32_g11848 ) , temp_output_1_0_g11848.a));
				...
				float3 temp_output_40_0_g11852 = ( staticSwitch50_g11852 * pow( ( ( break2_g11854.x + break2_g11854.x + break2_g11854.y + break2_g11854.y + break2_g11854.y + break2_g11854.z ) / 6.0 ) , max( _EnchantedContrast , 0.001 ) ) * _EnchantedBrightness );
				...
				#endif
				float3 lerpResult31_g11857 = lerp( appendResult32_g11857 , ( staticSwitch26_g11857 * pow( temp_output_4_0_g11857 , max( _ShiftingContrast , 0.001 ) ) ) , _ShiftingFade);
				...
				float3 staticSwitch80_g11864 = ( pow( ( ( break2_g11866.x + break2_g11866.x + break2_g11866.y + break2_g11866.y + break2_g11866.y + break2_g11866.z ) / 6.0 ) , max( _TextureLayer1Contrast , 0.001 ) ) * temp_output_16_0_g11864 );
				#else
				...
				float3 staticSwitch84_g11860 = ( pow( ( ( break2_g11862.x + break2_g11862.x + break2_g11862.y + break2_g11862.y + break2_g11862.y + break2_g11862.z ) / 6.0 ) , max( _TextureLayer2Contrast , 0.001 ) ) * temp_output_16_0_g11860 );
				#else
				...
				float3 staticSwitch17_g11886 = ( staticSwitch16_g11886 * pow( ( ( break2_g11888.x + break2_g11888.x + break2_g11888.y + break2_g11888.y + break2_g11888.y + break2_g11888.z ) / 6.0 ) , max( _AddColorContrast , 0.001 ) ) );
				#else
				...
				float3 staticSwitch22_g11890 = ( pow( ( ( break2_g11892.x + break2_g11892.x + break2_g11892.y + break2_g11892.y + break2_g11892.y + break2_g11892.z ) / 6.0 ) , max( _StrongTintContrast , 0.001 ) ) * staticSwitch21_g11890 );
				#else
...
ASEEND*/
//CHKSM=3B886C40A9492FB0D7DD3C16FA10335DA05ED671
